...
module.exports = {
    ...
    messages: {
        ...
        "open-log-file": function () {
            o.shell.openItem(Editor.logfile)
        },
        "console:clear"(o, e, n) {
            Editor.clearLog(e, n)
        },
        "popup-open-log-menu": function (e, n, l) {
            ...
            n = Math.floor(n), l = Math.floor(l), i.nativeMenu.popup(o.BrowserWindow.fromWebContents(e.sender), n, l), i.dispose()
        },
        "popup-item-menu"(n, l, r, i) {
            ...
            l = Math.floor(l), r = Math.floor(r), p.nativeMenu.popup(o.BrowserWindow.fromWebContents(n.sender), l, r), p.dispose()
        },
        "app:play-on-device"() {
