...
process.on("unhandledRejection", i => {
    console.error(i)
}), exports.startup = async function (r, n) {
    ...
    if (!Editor.argv._command) try {
        ...
        u = i.isNew, await Editor.Project.init()
    } catch (i) {
        return n(i), void 0
    }
    await l(), await async function () {
        try {
    ...
    try {
        ...
        return await Editor.Engine.revertEngineDialog(i, Editor.T("EDITOR_MAIN.init_engine_extends_failed"), Editor.T("EDITOR_MAIN.init_engine_extends_failed_detail")), n(i)
    }(function () {
    ...
    try {
        ...
        return await Editor.Engine.revertEngineDialog(i, Editor.T("EDITOR_MAIN.register_builtin_assets_failed"), Editor.T("EDITOR_MAIN.register_builtin_assets_failed_detail")), n(i)
    }
    try {
        ...
        return Editor.AssetDB.loading = !1, n(i)
    }
    let E = require("../share/engine-utils");
    Editor.builtinCocosRoot = E.getEnginePath();
    try {
