...
let e = {
    ...
    queryPathByUrl: (e, s) => Editor.Ipc.sendToMain("asset-db:query-path-by-url", e, s, -1),
    queryUuidByUrl: (e, s) => Editor.Ipc.sendToMain("asset-db:query-uuid-by-url", e, s, -1),
    queryPathByUuid: (e, s) => Editor.Ipc.sendToMain("asset-db:query-path-by-uuid", e, s, -1),
    queryUrlByUuid: (e, s) => Editor.Ipc.sendToMain("asset-db:query-url-by-uuid", e, s, -1),
    queryInfoByUuid: (e, s) => Editor.Ipc.sendToMain("asset-db:query-info-by-uuid", e, s, -1),
    queryMetaInfoByUuid: (e, s) => Editor.Ipc.sendToMain("asset-db:query-meta-info-by-uuid", e, s, -1),
