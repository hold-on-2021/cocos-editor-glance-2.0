...
function m(r, n) {
    ...
    a(t.join(r._importPath, "**/*"), (a, s) => {
        i.each(s, (i, a) => {
            ...
            let n = o.exec(i);
            return n ? (n = n[0], void 0 !== r._uuid2path[n] ? (a(), void 0) : (r.log(`remove unused import file ${n}`), d(r, n, e => {
...
function v(i, r, n, o, l) {
    let d = r;
    e.isDirSync(r) && (d = t.join(r, "**/*"), i._isMountPath(r) || (d = [r, d]));
    let h = [];
    a(d, (a, r) => {
        if (a) return l && l(a), void 0;
        r.forEach(a => {
            let r;
            if (a = t.normalize(a), ".meta" === t.extname(a)) return o && f(i, a), void 0;
            let l, d = a + ".meta";
            if (d = a + ".meta", e.existsSync(d)) {
                if (!(r = u.load(i, d)).uuid || i._uuid2path[r.uuid]) {
                    const e = s();
                    i.warn(`uuid collision, the uuid(${r.uuid}) for ${a} is already used. A new uuid(${e}) will be assigned.`), r.uuid = e, u.save(i, d, r)
                }
                    ...
                    if (e)
                        for (let n in e) {
                            ...
                            if (i._uuid2path[o.uuid]) {
                                const e = s();
                                i.warn(`uuid collision, the uuid(${o.uuid}) for ${l} is already used. A new uuid(${e}) will be assigned.`), o.uuid = e, u.save(i, d, r)
                            }
                            i._dbAdd(l, o.uuid), h.push({
                                assetpath: l,
                                meta: o
                            })
                        }
            ...
            n && (l = n[a]), r = u.create(i, d, l), i._dbAdd(a, r.uuid), u.save(i, d, r), h.push({
                assetpath: a,
                meta: r
            })
        }), l && l(null, h)
...
function g(e, a, r) {
    let n = !1,
        o = a + ".meta",
        s = u.load(e, o);
    if (!s && (s = u.create(e, o), n = !0, !s)) return r && r(new Error(`Can not create or load meta from ${a}`)), void 0;
    if (e.isSubAssetByPath(a)) return r && r(null, s), void 0;
    let l = s.constructor.version();
    s.ver !== l && (s.ver = l, n = !0);
    let d = s.copySubMetas(),
        f = {};
    i.series([t => {
        if (s.import) try {
            e.log(`import asset ${a}...`), s.import(a, e => {
                f = s.getSubMetas() || {}, n = !0, t(e)
            })
        } catch (e) {
            t(e)
        } else t()
...
function $(e, a, r) {
    ...
    let n = !1,
        o = a.path,
        s = o + ".meta",
        l = a.meta || u.get(e, e.fspathToUuid(o)),
...
module.exports = l, l.mount = function (i, a, r, n, s) {
...
}, l.attachMountPath = function (e, t, a) {
    var r = [],
        n = e._mounts[t];
    return n ? n.attached ? (e.log(`db://${t} already attached!`), a(null, r), void 0) : (r.push({
        ...
        e.log(`init meta files at db://${t}`), v(e, a, null, !1, (e, t) => {
            i()
        })
    }, i => {
        let a = e._mounts[t].path;
        e.log(`refresh at db://${t}`), _(e, a, !1, (a, n) => {
...
}, l.unattachMountPath = function (e, a, r) {
    var n = [],
        o = e._mounts[a];
...
}, l.refresh = function (a, r, n) {
    let o = [],
        s = {};
    for (let e in a._path2uuid) s[e] = a._path2uuid[e];
    Array.isArray(r) || (r = [r]), r = (r = r.map((e, i) => {
        if (a._isAssetPath(e)) return e;
        a.isSubAssetByPath(e) && (e = t.dirname(e));
        let r = e,
            n = t.dirname(e);
        for (; n && !a._path2uuid[n];)(r = n) === (n = t.dirname(n)) && (r = n = void 0, a.failed(`Failed to refresh path: ${e}`));
        return r
    })).filter(Boolean), i.waterfall([e => {
        let t = [];
        i.eachSeries(r, (e, i) => {
            if (!a.fspathToUuid(e)) return i(), void 0;
            l.clearImports(a, e, s, (e, a) => {
                if (e) return i(), void 0;
                t = t.concat(a), i()
            })
        }, () => {
        ...
        i.eachSeries(r, (e, t) => {
            v(a, e, s, !1, (e, i) => {
                i.forEach(e => {
                    ...
                    !t || t !== e.meta.uuid || !i || i !== e.assetpath
                }), t()
            })
        }, e)
    }, e => {
    ...
    for (let i = 0; i < r.length; ++i) {
        ...
        if (e.isMountByPath(l)) n = t.basenameNoExt(m.mountPath), s = "mount";
        else {
            "folder" === (s = u.get(e, e.fspathToUuid(l)).assetType()) ? (n = t.basename(l), o = "") : n = t.basenameNoExt(l)
        }
        let p = {
            uuid: d,
            parentUuid: f,
    ...
    i && i(null, a)
}, l.queryAssets = function (e, t, i, a) {
    let n = [],
...
}, l.queryMetas = function (e, t, i, a) {
    let n = [],
        o = Object.keys(e._path2uuid);
    t && (o = r.match(o, t));
    for (let t = 0; t < o.length; ++t) {
        let a = o[t],
            r = u.get(e, e.fspathToUuid(a));
        if (!r) {
...
}, l.assetMove = function (a, r, n, o) {
    let s, l, f, h, m = e.isDirSync(r),
    ...
    i.series([e => {
        (function (e, i, a, r) {
            ...
            l = r, f = (s = i).map(e => a.fspathToUuid(e)), h = s.map(e => {
                return u.get(a, a.fspathToUuid(e)).copySubMetas()
            }), e()
        })
    }, e => {
    ...
    i.each(s, (t, i) => {
        (async function (t, i, a) {
            ...
            if (e) {
                ...
                return a.error(`Failed to delete asset ${r}, messages: ${e.stack}`), i(e), void 0
            }
            u = u.concat(r), i()
        })
    }, e => {
...
}, l.saveMeta = function (e, a, r, n) {
    let o, s = e.uuidToFspath(a);
    ...
    i.eachSeries(s, (t, r) => {
        ...
        l.push(o), i.series([i => {
            ...
            if (l) r = u.load(a, o);
                ...
                r = new(u.findCtor(a, t))(a)
            }
            if (r && r.delete) return l || a.warn(`Try to delete imported files from an un-exists path : ${o}.\n              This is not 100% work, please check them manually.`), r.uuid = n && n[t] || s, a.log(`do meta.delete ${o}...`), r.delete(t, i), void 0;
            i()
        }, e => {
            d(a, s, t => {
                t && a.failed(`Failed to delete imported assets of ${s} during clearImports, message: ${t.stack}`), e()
            })
        }, e => {
    ...
    i.series([t => {
        ...
        let r = [t.join(s, "**/*.meta")];
        a(r, (e, a) => {
            Promise.all(a.map(e => (e = t.resolve(e), n(e, {
                force: !0
            })))).then(e => {
                i()
            }, i)
...
}, l.exchangeUuid = function (e, t, a, r) {
    ...
    n.uuid = o.uuid, o.uuid = s, e._uuid2meta[n.uuid] = n, e._path2uuid[t] = n.uuid, e._uuid2path[n.uuid] = t, e._uuid2meta[o.uuid] = o, e._path2uuid[a] = o.uuid, e._uuid2path[o.uuid] = a, i.series([t => {
        l.saveMeta(e, n.uuid, JSON.stringify(n.serialize(), null, 2), t)
    }, t => {
        l.saveMeta(e, o.uuid, JSON.stringify(o.serialize(), null, 2), t)
    }], r)
}, l._backupUnusedMeta = h, l._scan = c, l._checkIfReimport = y, l._initMetas = v, l._refresh = _, l._importAsset = g, l._checkMoveInput = function (i, a, r, n) {
    let o = t.dirname(r),
        s = e.existsSync(a),
        u = e.existsSync(r),
        l = e.isDirSync(a),
